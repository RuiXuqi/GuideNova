...
class LangUtilTest {
    private static final Set<String> supportedLanguages = Set.of(
            "de_de",
            "fr_fr",
            "en_us",
            "es_es");
    ...
    @ParameterizedTest
    @CsvSource({
            "ns:_de_de/a/b/d/e.md, de_de", // valid language code
    ...
    @ParameterizedTest
    @CsvSource({
            "ns:_de_de/a/b/d/e.md, ns:a/b/d/e.md", // valid language code
